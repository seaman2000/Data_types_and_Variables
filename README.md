...
### ☑️ 1. [concat_names](concat_names.py)
...
Jan<->White
```
### ☑️ 2. [convert_meters_to_kilometers](convert_meters_to_kilometers.py)
...
2.66
```
### ☑️ 3. [pounds_to_dollars](pounds_to_dollars.py)
...
### ☑️ 4. [centuries_to_minutes](centuries_to_minutes.py)
...
```
### ☑️ 5. [special_numbers](special_numbers.py)
Write a program that reads an integer n. Then, for all numbers in the range [1, n], print the number and if it is special or not (True / False).  
...
6 -> False
```
### ☑️ 6. [next_happy_year](next_happy_year.py)
